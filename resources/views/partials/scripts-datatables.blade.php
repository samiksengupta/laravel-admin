...
<script>
	...
	function setDataTableOptions() {
		...
		listView.dtOptions = $(listView.tableSelector).data('options');
		let ajaxData = {};
		
		if(ok(listView.dtOptions.ajax)) {
			listView.dtOptions.ajax['data'] = listView.dtOptions.ajax.data ?? ajaxData;
		}
	}

	function drawColumns() {
		let thead = $(listView.tableSelector).find('thead');
		thead.append($('<tr/>'));
		let tr = thead.find('tr');
		for(index in listView.dtOptions.columns) {
			const item = listView.dtOptions.columns[index];
	...
	function initDataTables() {
		...
		table = $(listView.tableSelector).DataTable(listView.dtOptions);
